...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: tifinagh, canadian-aboriginal, old-permic, tai-le, malayalam, math, todhri, hebrew, duployan, coptic, syriac</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: brahmi, kaithi, manichaean, duployan, devanagari, tai-tham, meetei-mayek, lepcha, yi, balinese, phags-pa, adlam, ahom, tai-le, symbols, buginese, syriac, syloti-nagri, caucasian-albanian, cham, khmer, rejang, lao, elbasan, kharoshthi, modi, chakma, new-tai-lue, sharada, marchen, buhid, siddham, psalter-pahlavi, music, newa, nko, tirhuta, oriya, bhaiksuki, soyombo, kayah-li, masaram-gondi, mahajani, canadian-aboriginal, tamil, coptic, tagbanwa, old-permic, malayalam, gunjala-gondi, saurashtra, tagalog, math, kannada, armenian, dogra, thaana, hanifi-rohingya, thai, tai-viet, mandaic, bengali, sundanese, tibetan, grantha, sogdian, hanunoo, warang-citi, zanabazar-square, takri, osage, limbu, mongolian, khojki, miao, batak, telugu, tifinagh, pahawh-hmong, javanese, bassa-vah, wancho, mende-kikakui, myanmar, gujarati, gurmukhi, hebrew, khudawadi, sinhala</li>
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Bafut (Latn, 158,146 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Mango (Latn, 77,000 speakers), Kom (Latn, 360,685 speakers), Teke-Ebo (Latn, 260,000 speakers), Yala (Latn, 200,000 speakers), Dii (Latn, 71,000 speakers), Dan (Latn, 1,099,244 speakers), Lugbara (Latn, 2,200,000 speakers), Vute (Latn, 21,000 speakers), Han (Latn, 6 speakers), Sar (Latn, 500,000 speakers), Ejagham (Latn, 120,000 speakers), Igbo (Latn, 27,823,640 speakers), Ebira (Latn, 2,200,000 speakers), Ma’di (Latn, 584,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Heiltsuk (Latn, 300 speakers), Avokaya (Latn, 100,000 speakers), Southern Kisi (Latn, 360,000 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Cicipu (Latn, 44,000 speakers), Zapotec (Latn, 490,000 speakers), Fur (Latn, 1,230,163 speakers), Kaska (Latn, 125 speakers), Mundani (Latn, 34,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Navajo (Latn, 166,319 speakers), Nateni (Latn, 100,000 speakers), Aghem (Latn, 38,843 speakers), Koonzime (Latn, 40,000 speakers), Ekpeye (Latn, 226,000 speakers), South Central Banda (Latn, 244,000 speakers), Mfumte (Latn, 79,000 speakers), Nzakara (Latn, 50,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Gulay (Latn, 250,478 speakers), Makaa (Latn, 221,000 speakers), Basaa (Latn, 332,940 speakers).</p>
 [code: soft-dotted]
