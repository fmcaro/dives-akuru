...
<details><summary>[18] NotoSerifDivesAkuru-Regular.ttf</summary>
<div>
<details>
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: math, old-permic, tai-le, coptic, canadian-aboriginal, malayalam, syriac, hebrew, tifinagh, duployan, todhri</li>
...
<li>U+25CC DOTTED CIRCLE: try adding one of: dogra, balinese, rejang, zanabazar-square, pahawh-hmong, telugu, wancho, mende-kikakui, psalter-pahlavi, canadian-aboriginal, hanunoo, khojki, tibetan, siddham, javanese, miao, bengali, buhid, hebrew, masaram-gondi, tifinagh, grantha, gujarati, tai-viet, devanagari, gunjala-gondi, tagbanwa, old-permic, new-tai-lue, lepcha, sinhala, marchen, phags-pa, sogdian, batak, tagalog, gurmukhi, osage, takri, kharoshthi, kannada, khudawadi, math, chakma, yi, elbasan, tai-tham, mongolian, music, limbu, mandaic, buginese, nko, caucasian-albanian, kayah-li, warang-citi, newa, duployan, hanifi-rohingya, bhaiksuki, sundanese, mahajani, modi, syriac, kaithi, cham, symbols, syloti-nagri, brahmi, tai-le, thai, saurashtra, myanmar, ahom, tamil, bassa-vah, manichaean, soyombo, khmer, adlam, meetei-mayek, armenian, lao, coptic, sharada, malayalam, oriya, thaana, tirhuta</li>
...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Ekpeye (Latn, 226,000 speakers), Dan (Latn, 1,099,244 speakers), Ukrainian (Cyrl, 29,273,587 speakers), Han (Latn, 6 speakers), Ebira (Latn, 2,200,000 speakers), South Central Banda (Latn, 244,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Zapotec (Latn, 490,000 speakers), Kom (Latn, 360,685 speakers), Koonzime (Latn, 40,000 speakers), Igbo (Latn, 27,823,640 speakers), Lugbara (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Southern Kisi (Latn, 360,000 speakers), Heiltsuk (Latn, 300 speakers), Fur (Latn, 1,230,163 speakers), Ejagham (Latn, 120,000 speakers), Mundani (Latn, 34,000 speakers), Yala (Latn, 200,000 speakers), Nzakara (Latn, 50,000 speakers), Makaa (Latn, 221,000 speakers), Mango (Latn, 77,000 speakers), Sar (Latn, 500,000 speakers), Gulay (Latn, 250,478 speakers), Kaska (Latn, 125 speakers), Nateni (Latn, 100,000 speakers), Basaa (Latn, 332,940 speakers), Cicipu (Latn, 44,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Ngbaka (Latn, 1,020,000 speakers), Bafut (Latn, 158,146 speakers), Aghem (Latn, 38,843 speakers), Mfumte (Latn, 79,000 speakers), Avokaya (Latn, 100,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Vute (Latn, 21,000 speakers), Dii (Latn, 71,000 speakers), Ma’di (Latn, 584,000 speakers), Teke-Ebo (Latn, 260,000 speakers), Belarusian (Cyrl, 10,064,517 speakers).</p>
 [code: soft-dotted]
